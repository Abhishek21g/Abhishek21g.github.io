              ...
              {galleryImages.map((src, idx) => (
                ...
                >
                  <img
                    src={src}
                    alt={''}
                    className={`w-full h-80 object-cover object-center transition-all duration-300 group-hover:brightness-110 group-hover:contrast-110${src.includes('IMG_8855') ? ' object-[center_top] scale-110' : ''}`}
                    style={src.includes('IMG_8855') ? { objectPosition: 'center top', transform: 'scale(1.1)' } : { display: 'block' }}
                  />
