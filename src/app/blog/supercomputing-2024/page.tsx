...
export default function Supercomputing2024Page() {
  return (
    <BlogArticlePage
      date="November 2024"
      hero="/claude-design/media/sc24-booth.jpg"
      kicker="SC24 Atlanta"
      ...
      media={[
        { src: '/claude-design/media/sc24-vr.jpg', alt: 'Omniverse digital twin demo on the show floor' },
        { src: '/claude-design/media/sc24-robot.jpg', alt: 'SC24 show floor moment' },
        { src: '/claude-design/media/sc24-crowd.jpg', alt: 'Conference floor and booth conversations' },
